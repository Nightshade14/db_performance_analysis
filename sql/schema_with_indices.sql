...
-- Indices for baseline query for better performance
CREATE INDEX idx_customer_unique_id ON olist_customers_dataset (customer_unique_id);

CREATE INDEX idx_order_customer_timestamp ON olist_orders_dataset (customer_id, order_purchase_timestamp);

CREATE INDEX idx_order_items_composite ON olist_order_items_dataset (order_id, product_id);
